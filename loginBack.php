<?php
    ...
    if($impri['total']){
        ...
        echo "<script type='text/javascript'>alert('El usuario o contraseña son incorrectos');location.href='index.php'</script>";    
        ///header('Location: index.php');//echo "El usuario o contraseña son incorrectos";
    }
